...
fn test_i8_support() -> Result<()> {
    ...
    let builder = hodu_xla::XlaBuilder::new("test_i8");
    let literal = hodu_xla::Literal::scalar(42i8);
    let constant = builder.constant_literal(&literal)?;
    let computation = constant.build()?;
    let executable = client.compile(&computation)?;
    let result = executable.execute::<hodu_xla::Literal>(&[])?;
...
fn test_i16_support() -> Result<()> {
    let client = hodu_xla::PjRtClient::cpu()?;
    let builder = hodu_xla::XlaBuilder::new("test_i16");
    let literal = hodu_xla::Literal::scalar(1234i16);
    let constant = builder.constant_literal(&literal)?;
    let computation = constant.build()?;
    let executable = client.compile(&computation)?;
    let result = executable.execute::<hodu_xla::Literal>(&[])?;
...
fn test_i32_support() -> Result<()> {
    let client = hodu_xla::PjRtClient::cpu()?;
    let builder = hodu_xla::XlaBuilder::new("test_i32");
    let literal = hodu_xla::Literal::scalar(123456i32);
    let constant = builder.constant_literal(&literal)?;
    let computation = constant.build()?;
    let executable = client.compile(&computation)?;
    let result = executable.execute::<hodu_xla::Literal>(&[])?;
...
fn test_i64_support() -> Result<()> {
    let client = hodu_xla::PjRtClient::cpu()?;
    let builder = hodu_xla::XlaBuilder::new("test_i64");
    let literal = hodu_xla::Literal::scalar(1234567890i64);
    let constant = builder.constant_literal(&literal)?;
    let computation = constant.build()?;
    let executable = client.compile(&computation)?;
    let result = executable.execute::<hodu_xla::Literal>(&[])?;
...
fn test_u8_support() -> Result<()> {
    let client = hodu_xla::PjRtClient::cpu()?;
    let builder = hodu_xla::XlaBuilder::new("test_u8");
    let literal = hodu_xla::Literal::scalar(255u8);
    let constant = builder.constant_literal(&literal)?;
    let computation = constant.build()?;
    let executable = client.compile(&computation)?;
    let result = executable.execute::<hodu_xla::Literal>(&[])?;
...
fn test_u16_support() -> Result<()> {
    let client = hodu_xla::PjRtClient::cpu()?;
    let builder = hodu_xla::XlaBuilder::new("test_u16");
    let literal = hodu_xla::Literal::scalar(65535u16);
    let constant = builder.constant_literal(&literal)?;
    let computation = constant.build()?;
    let executable = client.compile(&computation)?;
    let result = executable.execute::<hodu_xla::Literal>(&[])?;
...
fn test_u32_support() -> Result<()> {
    let client = hodu_xla::PjRtClient::cpu()?;
    let builder = hodu_xla::XlaBuilder::new("test_u32");
    let literal = hodu_xla::Literal::scalar(4294967295u32);
    let constant = builder.constant_literal(&literal)?;
    let computation = constant.build()?;
    let executable = client.compile(&computation)?;
    let result = executable.execute::<hodu_xla::Literal>(&[])?;
...
fn test_u64_support() -> Result<()> {
    let client = hodu_xla::PjRtClient::cpu()?;
    let builder = hodu_xla::XlaBuilder::new("test_u64");
    let literal = hodu_xla::Literal::scalar(18446744073709551615u64);
    let constant = builder.constant_literal(&literal)?;
    let computation = constant.build()?;
    let executable = client.compile(&computation)?;
    let result = executable.execute::<hodu_xla::Literal>(&[])?;
...
fn test_f32_support() -> Result<()> {
    let client = hodu_xla::PjRtClient::cpu()?;
    let builder = hodu_xla::XlaBuilder::new("test_f32");
    let literal = hodu_xla::Literal::scalar(std::f32::consts::PI);
    let constant = builder.constant_literal(&literal)?;
    let computation = constant.build()?;
    let executable = client.compile(&computation)?;
    let result = executable.execute::<hodu_xla::Literal>(&[])?;
...
fn test_f64_support() -> Result<()> {
    let client = hodu_xla::PjRtClient::cpu()?;
    let builder = hodu_xla::XlaBuilder::new("test_f64");
    let literal = hodu_xla::Literal::scalar(std::f64::consts::E);
    let constant = builder.constant_literal(&literal)?;
    let computation = constant.build()?;
    let executable = client.compile(&computation)?;
    let result = executable.execute::<hodu_xla::Literal>(&[])?;
...
fn test_f16_support() -> Result<()> {
    let client = hodu_xla::PjRtClient::cpu()?;
    let builder = hodu_xla::XlaBuilder::new("test_f16");
    let value = f16::from_f32(std::f32::consts::PI);
    let literal = hodu_xla::Literal::scalar(value);
    let constant = builder.constant_literal(&literal)?;
    let computation = constant.build()?;
    let executable = client.compile(&computation)?;
    let result = executable.execute::<hodu_xla::Literal>(&[])?;
...
fn test_bf16_support() -> Result<()> {
    let client = hodu_xla::PjRtClient::cpu()?;
    let builder = hodu_xla::XlaBuilder::new("test_bf16");
...
fn test_vec1_types() -> Result<()> {
    ...
    // Test i8 vector
    let builder = hodu_xla::XlaBuilder::new("test_i8_vec");
    let data_i8 = vec![1i8, 2i8, 3i8, 4i8];
    let literal = hodu_xla::Literal::vec1(&data_i8);
    let constant = builder.constant_literal(&literal)?;
    let computation = constant.build()?;
    let executable = client.compile(&computation)?;
    let result = executable.execute::<hodu_xla::Literal>(&[])?;
    ...
    // Test u8 vector
    let builder = hodu_xla::XlaBuilder::new("test_u8_vec");
    let data_u8 = vec![10u8, 20u8, 30u8, 40u8];
    let literal = hodu_xla::Literal::vec1(&data_u8);
    let constant = builder.constant_literal(&literal)?;
    let computation = constant.build()?;
    let executable = client.compile(&computation)?;
    let result = executable.execute::<hodu_xla::Literal>(&[])?;
    ...
    // Test f16 vector
    let builder = hodu_xla::XlaBuilder::new("test_f16_vec");
    let data_f16 = vec![f16::from_f32(1.0), f16::from_f32(2.0), f16::from_f32(3.0)];
    let literal = hodu_xla::Literal::vec1(&data_f16);
    let constant = builder.constant_literal(&literal)?;
    let computation = constant.build()?;
    let executable = client.compile(&computation)?;
    let result = executable.execute::<hodu_xla::Literal>(&[])?;
